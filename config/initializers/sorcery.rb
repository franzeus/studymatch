...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.key = "158981730800384"
  config.facebook.secret = "41ccb9bf378f837031e01b19cc932fef"
  config.facebook.callback_url = "http://localhost:3000/oauth/callback?provider=facebook"
  config.facebook.user_info_mapping = { :external_id => "id", :email => "email", :first_name => "first_name", :last_name => "last_name" }
  config.facebook.scope = "email, offline_access, user_education_history" #etc
  ...
  config.user_config do |user|
    ...
    # Default: `:user_id`
    #
    user.authentications_user_id_attribute_name = :student_id
